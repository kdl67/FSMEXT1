...
//
function getProject(cloudHost, account, company, serviceCall_id) {
  ...
  return new Promise(resolve => {
    ...
    fetch("https://de.fsm.cloud.sap/api/data/v4/ServiceCall/1F7C0EB08C374A028015F0C57EE1C667?account=polaris-sandbox&company=GT-Testing&dtos=ServiceCall.27", {
      headers
      })
